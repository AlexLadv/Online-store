...
const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description: 'Oracal Paris introduces Hyaluron Expert Replumping Serum formulated with 1.5% Hyaluronic Acid',
    price: 19,
  ...
  },
  {
    ...
    description:
      'Fair & Clear is Pakistan only pure Freckle cream which helpsfade Freckles, Darkspots and pigments. Mercury level is 0%, so there are no side effects.',
    price: 70,
  ...
  //   description: 'quality and professional print - It doesnt just look high quality, it is high quality.',
  //   price: 10,
  ...
  //   description: 'Stylish Watch For Man (Luxury) Classy Mens Stainless Steel Wrist Watch - Box Packed',
  //   price: 47,
  ...
  //   description:
  //     'Buy this awesome  The product is originally manufactured by the company and its a top selling product with a very reasonable',
  //   price: 60,
